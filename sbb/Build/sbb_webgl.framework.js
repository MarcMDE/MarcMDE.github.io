...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getMetricsInfo')) {
        Object.defineProperty(Module['ready'], '_getMetricsInfo', { configurable: true, get: function() { abort('You are getting _getMetricsInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getMetricsInfo', { configurable: true, set: function() { abort('You are setting _getMetricsInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
if (!navigator.mediaDevices) {
	if (typeof ENVIRONMENT_IS_PTHREAD === "undefined" || !ENVIRONMENT_IS_PTHREAD) console.warn('navigator.mediaDevices not supported by this browser. Webcam access will not be available.' + (location.protocol == 'https:' ? '' : ' Try hosting the page over HTTPS, because some browsers disable webcam access when insecure HTTP is being used.'));
	disableAccessToMediaDevices();
...
var ASM_CONSTS = {
  4560112: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4560167: function($0) {performance.now = function() { return $0; };},  
 4560215: function($0) {performance.now = function() { return $0; };},  
 4560263: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4560318: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4560379: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4560443: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function JS_Accelerometer_eventHandler() {
          ...
          if (JS_Accelerometer_callback != 0)
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_Accelerometer_callback, a1, a2, a3]); })(JS_Accelerometer_lastValue.x, JS_Accelerometer_lastValue.y, JS_Accelerometer_lastValue.z);
      }
  ...
  function JS_DeviceMotion_eventHandler(event) {
          ...
          if (JS_Accelerometer_callback != 0)
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_Accelerometer_callback, a1, a2, a3]); })(accelerometerValue.x, accelerometerValue.y, accelerometerValue.z);
          ...
          if (JS_LinearAccelerationSensor_callback != 0)
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_LinearAccelerationSensor_callback, a1, a2, a3]); })(linearAccelerationValue.x, linearAccelerationValue.y, linearAccelerationValue.z);
          ...
          if (JS_GravitySensor_callback != 0) {
              ...
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_GravitySensor_callback, a1, a2, a3]); })(gravityValue.x, gravityValue.y, gravityValue.z);
          }
          ...
          if (JS_Gyroscope_callback != 0) {
              ...
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_Gyroscope_callback, a1, a2, a3]); })(event.rotationRate.alpha * degToRad, event.rotationRate.beta * degToRad, event.rotationRate.gamma * degToRad);
          }
      }
  ...
  function JS_GravitySensor_eventHandler() {
          if (JS_GravitySensor_callback != 0)
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_GravitySensor_callback, a1, a2, a3]); })(
  ...
  function JS_Gyroscope_eventHandler() {
          // Radians per second
          if (JS_Gyroscope_callback != 0)
              (function(a1, a2, a3) {  dynCall_vfff.apply(null, [JS_Gyroscope_callback, a1, a2, a3]); })(JS_Gyroscope.x, JS_Gyroscope.y, JS_Gyroscope.z);
      }
  ...
  function JS_OrientationSensor_eventHandler() {
          if (JS_OrientationSensor_callback != 0)
              (function(a1, a2, a3, a4) {  dynCall_vffff.apply(null, [JS_OrientationSensor_callback, a1, a2, a3, a4]); })(JS_OrientationSensor.quaternion[0], JS_OrientationSensor.quaternion[1], JS_OrientationSensor.quaternion[2], JS_OrientationSensor.quaternion[3]);
      }
  ...
  function JS_DeviceOrientation_eventHandler(event) {
          if (JS_OrientationSensor_callback) {
              ...
              (function(a1, a2, a3, a4) {  dynCall_vffff.apply(null, [JS_OrientationSensor_callback, a1, a2, a3, a4]); })(qx, qy, qz, qw);
          }
      }
  ...
  function JS_ScreenOrientation_eventHandler() {
  		if (JS_ScreenOrientation_callback) (function(a1, a2, a3) {  dynCall_viii.apply(null, [JS_ScreenOrientation_callback, a1, a2, a3]); })(window.innerWidth, window.innerHeight, screen.orientation ? screen.orientation.angle : window.orientation);
  	}
  	...
  	channel.playSoundClip = function (soundClip, startTime, startOffset) {
  		try {
  			...
  			this.source.onended = function () {
  				...
  				if (self.callback) {
  					(function(a1) {  dynCall_vi.apply(null, [self.callback, a1]); })(self.userData);
  				}
  			};
...
/** @type {function(...*):?} */
var dynCall_viiffiiiiiiiiiiiiiiiiiiiiiiiii = Module["dynCall_viiffiiiiiiiiiiiiiiiiiiiiiiiii"] = createExportWrapper("dynCall_viiffiiiiiiiiiiiiiiiiiiiiiiiii");
